...
% \begin{definition}[Difference of Two Sets]
%     \hl{fill this in}  % TODO
% \end{definition}
...
\end{theorem}
\begin{proof}
    \hl{details to be filled in}  % TODO
\end{proof}
...
\begin{axiom}[Infinity]
    ...
    We call this set the \emph{set of natural numbers} and use the symbol \(\mathbb{N}\) to denote it.
\end{axiom}
