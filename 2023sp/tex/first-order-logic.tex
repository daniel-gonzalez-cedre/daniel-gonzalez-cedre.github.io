    ...
    \begin{minipage}[t]{.45\linewidth}
        \begin{table}[H]
            ...
            \begin{tabular}{|Cc|l|l|} \hline
                ...
                \thead{Deduction} & \thead[l]{If by assuming \(p\) \\ we are able to derive \(q\),\\ then we can derive \(p \rightarrow q\)} & \thead[l]{\(\begin{array}{c} p \implies q \\ \cline{1-1} p \rightarrow q\end{array}\)} \\ \hline
                ...
                \thead{Reductio \\ ad Absurdum} & \thead[l]{If by assuming \(p\) \\ we can derive both \(q\) and \(\neg q\),\\ then we can derive \(\neg p\)} & \thead[l]{\(\begin{array}{l} p \implies q \\ p \implies \neg q \\ \cline{1-1} \neg p \end{array}\)} \\ \hline
            \end{tabular}
        \end{table}
    \end{minipage}
\end{center}
