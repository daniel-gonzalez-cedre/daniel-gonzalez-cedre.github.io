...
\footnotetext[2]{This is true in any ordered semiring where exponentiation is defined recursively in terms of multiplication.}
\footnotetext[3]{You can assume ``basic grade-school'' properties of algebra like these without special mention.}
